...
// WICHTIG: Reihenfolge ist kritisch! Hauptmenü muss ZUERST geladen werden!
$includes = [
    'includes/asu-functions.php',
    'includes/asu-admin-page.php',     // Auto Clean Up (Hauptmenü) - MUSS ZUERST sein!
    'includes/asu-alttext.php',        // Alt-Text Manager (Submenü)
    'includes/asu-webp.php',           // WebP Konvertierung (Submenü)
    'includes/asu-ajax-handlers.php',
    'includes/asu-plugin-installer.php',
    'includes/asu-duplicate.php',
    'includes/asu-auto-updates.php',
    'includes/asu-settings.php',       // Einstellungen (Submenü, ganz nach unten)
];
